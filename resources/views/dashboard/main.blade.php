                    ...
                    <div class="row">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <span class="text-success small pt-1 fw-bold">12%</span> <span
                                                class="text-muted small pt-2 ps-1">bertambah</span>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Laporan Bulanan <span>| Laba</span></h5>
                            ...
                            <div class="card">
                                ...
                                <div class="filter">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        ...
                                        <li><a class="dropdown-item" href="#">Buat Pengeluaran</a></li>
                                        <li><a class="dropdown-item" href="#">Buat Pemasukan</a></li>
                                        <li><a class="dropdown-item" href="#">Cetak Laporan</a></li>
                                    </ul>
                                </div>

                                <div class="card-body">
                                    <h5 class="card-title">Laporan Keuangan Harian <span>| Minggu Ini</span></h5>
